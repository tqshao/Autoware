...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.button_chrono = wx.ToggleButton(self.tab_simulation, wx.ID_ANY, _("Chrono"))
		...
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnLaunchKill, self.button_chrono)
	...
	def __do_layout(self):
		...
		sizer_47_copy.Add(self.button_chrono, 0, wx.ALL, 4)
