...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.button_chrono_path = wx.ToggleButton(self.tab_simulation, wx.ID_ANY, _("Chrono_path"))
		...
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnLaunchKill, self.button_chrono_path)
	...
	def __do_layout(self):
		...
		sizer_47_copy.Add(self.button_chrono_path, 0, wx.ALL, 4)
